...
class SleepTrackerFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        // Application Context Cannot Be Null Or Else An Exception Will Be Thrown
        val application = requireNotNull(this.activity).application

        // Get An Instance Of The DAO So We Can Interact With The Database
       ...
       binding.setLifecycleOwner(this)
        ...
        sleepTrackerViewModel.showSnackbarEvent.observe(this, Observer { shouldShowSnackBar ->
